            ...
            <table class="table table-bordered table-hover" id="dt">
                ...
                <tbody>
                    ...
                    $RowRunning = 0;
                            ...
                            $sum95 = $sum95  + $x_PriceProduct * 0.95 ;
                            $sum05 = $sum05 + $x_PriceProduct * 0.05;
...
?>
                    <tr>
                        ...
                        <td style="text-align: right;"> <?php echo @number_format($x_PriceProduct * 0.95 ,0);  ?> </td>

                        <td style="text-align: right;"> <?php echo @number_format($x_PriceProduct * 0.05,0);  ?> </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo @number_format($sum95,0); ?></td>
                    <td style="text-align: right;"><?php echo @number_format($sum05,0); ?></td>
    ...
    $("#dt").DataTable({
        ...
        buttons: [
            ...
            'excelHtml5' , 
            {
                extend: 'print',
            text: 'พิมพ์เอกสาร',
            title: '<h5> รายงานการขาย (ฝากขาย) </h5>  <h6> ระหว่างวันที่ : <?php echo $dt1; ?> ถึงวันที่ <?php echo $dt2; ?> <h6>',
            }
