...
<div class="container">
    ...
    <table class="table  table-hover" id="dtab">
        ...
        <tbody>
            ...
            foreach ($rStoreProductCode as $key_rStoreProductCode => $value_rStoreProductCode) {
                ?>
                <tr>
                    <td scope="row"><?php echo $value_rStoreProductCode->product_name; ?></td>
                    <td><?php echo number_format($value_rStoreProductCode->qty, 0); ?></td>
