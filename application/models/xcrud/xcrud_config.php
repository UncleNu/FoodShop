<?php 
/** Configuration file; f0ska xCRUD v.1.6.26; 03/2015 */
class Xcrud_config
{
    // default connection
//     $config['db_host'] = 'localhost';
// $config['db_name'] = 'thai-energy';
// $config['db_username'] = 'pwebasia_test';
...
// $config['db_prefix'] = 'ng_';
    ...
    public static $language = 'th'; // sets default localization
    ...
    // editor
    //  public static $editor_url = 'static/ck_cus/ckeditor.js'; // URL path to editor script, if you want to use the visual editor.
//    public static $editor_url = ''; // URL path to editor script, if you want to use the visual editor.
    public static $editor_url = 'static/ckeditor/ckeditor.js'; // URL path to editor script, if you want to use the visual editor.
    ...
    public static $limit_list = array('10', '25', '50', '100', 'all'); // default limits list
    ...
    public static $upload_folder_def = '../../../static/uploads'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.
    ...
    public static $autoclean_timeout = 120; // in seconds. Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
